...
- [Data Stores](data_stores/data_stores.md)
    - [Relational Databases](data_stores/relational_databases.md)
    - [NoSQL](data_stores/nosql.md)
...
- [Design Patterns](design_patterns/design_patterns.md)
    ...
    - [Functional](design_patterns/functional.md)
    - [Concurrency](design_patterns/concurrency.md)
    - [Architectural](design_patterns/architectural.md)
    - [Cloud Distributed](design_patterns/cloud_distributed.md)
    - [Testing](design_patterns/testing.md)
    - [Other](design_patterns/other.md)
    - [Anti-Patterns](design_patterns/anti_patterns.md)

- [Interview Prep](interview_prep/interview_prep.md)
    - [Personal/Anecdotal Questions](interview_prep/personal_anecdotal_questions.md)
    ...
    - [Questions To Ask](interview_prep/questions_to_ask.md)
